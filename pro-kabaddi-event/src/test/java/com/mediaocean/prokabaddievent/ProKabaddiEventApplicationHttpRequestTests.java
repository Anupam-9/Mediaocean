...
public class ProKabaddiEventApplicationHttpRequestTests {
	...
	public void addAll() throws JsonParseException, JsonMappingException, IOException {
		...
		ResponseEntity<List<Team>> returnTeamList = restTemplate.exchange(
	...
	/**
	 * 
	 * test for bulk add test generate schedule.
	 */
	@Test
	public void generateSchedule() throws JsonParseException, JsonMappingException, IOException {
		...
		ResponseEntity<List<Match>> returnMatchList = restTemplate.exchange(
				"http://localhost:" + port + "/prokabadi/schedule/generate/2019-03-04 11:30", HttpMethod.GET, null,
